...
export async function ensureDatabaseSeeded(force: boolean = false): Promise<{ seeded: boolean; message: string }> {
  ...
  try {
    ...
    const sellerData = [
      { name: "tunogkalye.net", email: "sarah@techshop.ca", store: "Canada Marketplace", storeSlug: "canada-marketplace", province: "ON", city: "Toronto", desc: "Canada Marketplace — Your trusted Canadian online store. Premium quality T-shirts, mugs, caps, and hoodies inspired by street sound culture. All prices in CAD." },
      { name: "Marco Reyes", email: "jp@montrealfashion.ca", store: "Canada Marketplace West", storeSlug: "canada-marketplace-west", province: "BC", city: "Vancouver", desc: "Canada Marketplace West Coast. Bringing premium streetwear and accessories to British Columbia. Your one-stop shop for Canadian style." },
      { name: "Émile Tremblay", email: "mike@homegear.ca", store: "Canada Marketplace Québec", storeSlug: "canada-marketplace-quebec", province: "QC", city: "Montréal", desc: "Canada Marketplace Québec — Votre marché en ligne de confiance. Produits premium pour la communauté québécoise. Tous les prix en CAD." },
      { name: "Aisha Khan", email: "emily@sportsplus.ca", store: "Canada Marketplace Prairies", storeSlug: "canada-marketplace-prairies", province: "AB", city: "Calgary", desc: "Canada Marketplace Prairies — Premium merchandise across Alberta and the Prairies. Quality products, Canadian prices." },
      { name: "Jordan Williams", email: "david@canread.ca", store: "Canada Marketplace Atlantic", storeSlug: "canada-marketplace-atlantic", province: "NS", city: "Halifax", desc: "Canada Marketplace Atlantic — East Coast quality, nationwide reach. Shipping across the Maritimes and beyond." },
    ]
        ...
        data: {
          ...
          store: {
            create: {
              ...
              websiteUrl: isLast ? 'https://canadamarketplace.ca' : null,
              vacationMode: isLast,
    ...
    const productTemplates = [
      ...
      { title: 'Tunog Kalye Classic Logo Tee — Black', cat: "apparel", seller: 0, price: 32.99, condition: "NEW", desc: "The iconic Tunog Kalye logo on premium 100% cotton. Classic black tee for street music lovers. Comfortable fit, durable print.", images: ["/products/merch-mug-cap-shirt.png", "/products/tshirt-classic-black.png"], isFeatured: true },
      { title: 'Tunog Kalye Classic Logo Tee — White', cat: "apparel", seller: 0, price: 32.99, condition: "NEW", desc: "The iconic Tunog Kalye logo on crisp white cotton. A clean look for any occasion. Comfortable fit, durable print.", images: ["/products/merch-polo-shirts.png", "/products/tshirt-classic-white.png"], isFeatured: false },
      { title: 'Tunog Kalye "Street Vibes" Graphic Tee', cat: "apparel", seller: 0, price: 34.99, condition: "NEW", desc: "Bold graphic design inspired by urban sound culture. Premium cotton blend with vibrant colours that last. Street vibes guaranteed.", images: ["/products/merch-collection.png", "/products/tshirt-street-vibes.png"], isFeatured: true },
      ...
      { title: 'Tunog Kalye "Kalye Life" Urban Tee', cat: "apparel", seller: 0, price: 32.99, condition: "NEW", desc: "Live the Kalye life! This urban tee celebrates the everyday rhythm of the streets. Comfortable and stylish, perfect for any day.", images: ["/products/merch-complete.png", "/products/tshirt-kalye-life.png"], isFeatured: false },
      // Mugs (by Tunog Kalye West - Seller 1) → Drinkware
      { title: 'Tunog Kalye Soundwave Ceramic Mug', cat: "drinkware", seller: 1, price: 17.99, condition: "NEW", desc: "Start your morning with the sound of Tunog Kalye. Premium ceramic mug with a sleek soundwave design. Microwave and dishwasher safe.", images: ["/products/merch-mugs-bg.png", "/products/mug-soundwave.png"], isFeatured: true },
      { title: 'Tunog Kalye Logo Travel Tumbler', cat: "drinkware", seller: 1, price: 22.99, condition: "NEW", desc: "Take Tunog Kalye on the go. Insulated stainless steel tumbler with the official logo. Keeps drinks hot or cold for hours.", images: ["/products/merch-mug-cap-shirt.png", "/products/mug-travel-tumbler.png"], isFeatured: false },
      ...
      { title: 'Tunog Kalye Trucker Hat', cat: "headwear", seller: 2, price: 27.99, condition: "NEW", desc: "Classic trucker style with Tunog Kalye flair. Mesh back for breathability, embroidered front logo. Perfect for summer.", images: ["/products/merch-mug-cap-shirt.png", "/products/cap-trucker.png"], isFeatured: false },
    ...
    const notificationTemplates = [
      ...
      { userId: buyers[0].id, type: "MESSAGE", title: "New Message", message: "Canada Marketplace sent you a message about Classic Logo Tee.", link: "messages" },
      ...
      { userId: sellers[2].id, type: "PAYOUT", title: "Payout Processed", message: "Your Canada Marketplace payout of $284.50 has been processed.", link: "my-payouts" },
