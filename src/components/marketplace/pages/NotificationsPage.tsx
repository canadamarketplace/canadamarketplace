...
function getTypeIcon(type: string) {
  return typeIcons[type] || { icon: Bell, color: 'text-stone-400', bg: 'bg-white/5 border-white/10' }
}
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <Bell className="w-12 h-12 text-stone-600 mx-auto mb-4" />
          <p className="text-stone-400 mb-4">Please sign in to view notifications</p>
          <Button
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <button
          onClick={() => navigate('home')}
          className="flex items-center gap-1.5 text-sm text-stone-500 hover:text-stone-300 mb-6 transition-colors"
        >
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {unreadCount > 0 && (
            <Button
              ...
              variant="outline"
              size="sm"
              className="border-white/10 text-stone-300 hover:bg-white/5 hover:text-stone-100"
            >
              {markingAll ? (
                ...
                {count > 0 && (
                  <span
                    className={`min-w-[20px] h-5 px-1.5 rounded-full text-[11px] font-medium flex items-center justify-center ${
                      isActive ? 'bg-red-500/20 text-red-300' : 'bg-white/5 text-stone-500'
                    }`}
                  >
                    {count > 99 ? '99+' : count}
                  </span>
        ...
        {loading ? (
          ...
          <div className="bg-neutral-900 border border-white/5 rounded-xl p-12 text-center">
            <BellOff className="w-12 h-12 text-stone-600 mx-auto mb-4" />
            <h3 className="text-lg font-medium text-stone-400 mb-2">No notifications</h3>
          ...
          <div className="space-y-2">
            {visibleNotifications.map((notification) => {
              ...
              return (
                <div
                  key={notification.id}
                  className={`group bg-neutral-900 border rounded-xl p-4 transition-all hover:border-white/15 ${
                    !notification.isRead
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <div className="shrink-0 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          ...
                          <button
                            ...
                            disabled={isDeleting}
                            className="p-1.5 rounded-lg hover:bg-red-500/10 text-stone-500 hover:text-red-400 transition-colors disabled:opacity-50"
                      ...
                      <div className="flex items-center gap-3 mt-2">
                        ...
                        <span
                          className="text-[10px] text-stone-600 uppercase tracking-wider font-medium px-1.5 py-0.5 rounded bg-white/5"
            ...
            {hasMore && (
              <div className="flex justify-center pt-4">
                <Button
                  ...
                  variant="outline"
                  className="border-white/10 text-stone-400 hover:bg-white/5 hover:text-stone-200"
                >
