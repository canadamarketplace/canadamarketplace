    ...
    <div className="min-h-screen bg-cm-bg">
      ...
      <section className="relative py-24 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-neutral-800 mb-6">
            ...
            <span className="text-xs font-medium text-cm-muted uppercase tracking-[0.2em]">Our Story</span>
          </div>
      ...
      <section className="px-6 py-16">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={stat.label} className="text-center p-6 rounded-2xl bg-cm-hover border border-cm-border-subtle">
              <span className="text-3xl mb-2 block">{stat.icon}</span>
              <div className="text-3xl md:text-4xl font-bold text-cm-primary mb-1">{stat.value}</div>
              <div className="text-xs text-cm-dim uppercase tracking-wider">{stat.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="px-6 py-16">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-8 rounded-2xl bg-cm-hover border border-cm-border-subtle">
            ...
            <h2 className="text-2xl font-bold text-cm-primary mb-3">Our Mission</h2>
            <p className="text-cm-muted font-light leading-relaxed">
          ...
          <div className="p-8 rounded-2xl bg-cm-hover border border-cm-border-subtle">
            ...
            <h2 className="text-2xl font-bold text-cm-primary mb-3">Our Vision</h2>
            <p className="text-cm-muted font-light leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={value.title}
                className="p-6 rounded-2xl bg-cm-hover border border-cm-border-subtle hover:border-cm-border-hover transition-all group"
              >
                ...
                <h3 className="text-lg font-semibold text-cm-primary mb-2">{value.title}</h3>
                <p className="text-sm text-cm-muted font-light leading-relaxed">{value.desc}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="relative">
            ...
            {[
              ...
              <div key={idx} className={`relative flex items-start gap-6 mb-12 ${idx % 2 === 1 ? 'md:flex-row-reverse md:text-right' : ''}`}>
                {/* Dot */}
                <div className="absolute left-4 md:left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-gradient-to-br from-red-500 to-red-500 border-2 border-cm-bg mt-2 z-10" />
                {/* Content */}
                <div className={`ml-12 md:ml-0 md:w-1/2 ${idx % 2 === 1 ? 'md:pl-8' : 'md:pr-8'}`}>
                  <span className="text-sm font-bold text-red-400">{item.year}</span>
                  <h3 className="text-lg font-semibold text-cm-primary mt-1">{item.title}</h3>
                  <p className="text-sm text-cm-muted font-light mt-2 leading-relaxed">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="px-6 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-cm-muted font-light max-w-2xl mx-auto mb-12 leading-relaxed">
          ...
          <div className="p-8 rounded-2xl bg-cm-hover border border-cm-border-subtle">
            <div className="flex flex-wrap items-center justify-center gap-8 text-sm text-cm-muted">
            ...
            <div className="flex items-center justify-center gap-2 mt-4 text-xs text-cm-dim">
      ...
      <section className="px-6 py-20">
        <div className="max-w-3xl mx-auto text-center">
          <div className="p-10 rounded-2xl bg-gradient-to-br from-red-900/20 via-neutral-900/50 to-red-900/10 border border-cm-border-subtle">
