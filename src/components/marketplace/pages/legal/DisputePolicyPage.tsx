    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="rounded-2xl bg-neutral-900/60 border border-white/5 p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-2xl font-bold text-stone-100">Dispute Policy</h1>
        </div>
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-6 text-stone-400 leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-stone-200 mb-3">1. Dispute Window</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-stone-200 mb-3">2. Valid Dispute Reasons</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-stone-200 mb-3">3. How to File a Dispute</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-stone-200 mb-3">4. Resolution Process</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-stone-200 mb-3">5. Escrow Protection</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-stone-200 mb-3">6. Final Decisions</h2>
