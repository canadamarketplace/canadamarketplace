    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="rounded-2xl bg-cm-elevated border border-cm-border-subtle p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-2xl font-bold text-cm-primary">Terms of Service</h1>
        </div>
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-6 text-cm-muted leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-cm-secondary mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-cm-secondary mb-3">2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-cm-secondary mb-3">3. User Accounts</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-cm-secondary mb-3">4. Seller Responsibilities</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-cm-secondary mb-3">5. Escrow and Payments</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-cm-secondary mb-3">6. Dispute Resolution</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-cm-secondary mb-3">7. Prohibited Items</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-cm-secondary mb-3">8. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-cm-secondary mb-3">9. Privacy</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-cm-secondary mb-3">10. Changes to Terms</h2>
