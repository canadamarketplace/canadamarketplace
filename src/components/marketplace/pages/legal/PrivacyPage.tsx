          ...
          <div className="rounded-2xl bg-gradient-to-br from-green-900/10 to-emerald-900/5 border border-green-500/10 p-8">
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <h2 className="text-xl font-bold text-stone-100 mb-1">Privacy Compliance Officer</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03]">
                    ...
                    <div>
                      ...
                      <a href="mailto:privacy@canadamarketplace.ca" className="text-sm text-stone-200 hover:text-green-400 transition-colors">privacy@canadamarketplace.ca</a>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03]">
                    <Mail className="w-4 h-4 text-green-400 flex-shrink-0" />
                    <div>
                      <p className="text-xs text-stone-500">General Inquiries</p>
                      <a href="mailto:support@canadamarketplace.ca" className="text-sm text-stone-200 hover:text-green-400 transition-colors">support@canadamarketplace.ca</a>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03]">
                    ...
                    <div>
                      ...
                      <a href="tel:+16044971001" className="text-sm text-stone-200 hover:text-green-400 transition-colors">(604) 497-1001</a>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03]">
                    <MapPin className="w-4 h-4 text-green-400 flex-shrink-0" />
                    <div>
                      <p className="text-xs text-stone-500">Mailing Address</p>
                      <p className="text-sm text-stone-200">14914 104 Ave, Unit 105, Surrey, BC V3R 1M7</p>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={item.title} className="p-5 rounded-2xl bg-white/[0.03] border border-white/5">
                <div className="w-10 h-10 rounded-xl bg-green-500/10 flex items-center justify-center mb-3">
                  <item.icon className="w-5 h-5 text-green-400" />
                </div>
                <h3 className="text-sm font-semibold text-stone-200 mb-1.5">{item.title}</h3>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="rounded-2xl bg-white/[0.03] border border-white/5 p-8">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-xl font-bold text-stone-100">Full Privacy Policy</h2>
            </div>
            <p className="text-xs text-stone-600 mb-8">Last updated: January 1, 2025 · Effective Date: January 1, 2025</p>

            <div className="space-y-8 text-stone-400 leading-relaxed">
              <section>
                <h3 className="text-lg font-semibold text-stone-200 mb-3">1. Introduction</h3>
              ...
              <section>
                <h3 className="text-lg font-semibold text-stone-200 mb-3">2. Data Storage & Canadian Residency</h3>
              ...
              <section>
                <h3 className="text-lg font-semibold text-stone-200 mb-3">3. Information We Collect</h3>
                <p className="mb-3">We collect information in the following categories:</p>
                <div className="space-y-4">
                  <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
                    <h4 className="text-sm font-semibold text-stone-200 mb-2">Information You Provide Directly</h4>
                    <ul className="text-sm space-y-1 text-stone-500">
                  ...
                  <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
                    <h4 className="text-sm font-semibold text-stone-200 mb-2">Information Collected Automatically</h4>
                    <ul className="text-sm space-y-1 text-stone-500">
              ...
              <section>
                <h3 className="text-lg font-semibold text-stone-200 mb-3">4. How We Use Your Information</h3>
                ...
                <p className="mt-4 text-sm"><strong className="text-stone-300">We do not sell, rent, or trade your personal information to third parties for marketing purposes.</strong></p>
              </section>

              <section>
                <h3 className="text-lg font-semibold text-stone-200 mb-3">5. Your Rights Under PIPEDA</h3>
              ...
              <section>
                <h3 className="text-lg font-semibold text-stone-200 mb-3">6. Data Security</h3>
              ...
              <section>
                <h3 className="text-lg font-semibold text-stone-200 mb-3">7. Data Breach Notification</h3>
              ...
              <section>
                <h3 className="text-lg font-semibold text-stone-200 mb-3">8. Data Retention</h3>
              ...
              <section>
                <h3 className="text-lg font-semibold text-stone-200 mb-3">9. Contact Our Privacy Officer</h3>
                ...
                <div className="p-4 rounded-xl bg-green-900/10 border border-green-500/10">
                  <p className="text-sm text-stone-300 font-semibold">Privacy Officer</p>
                  <p className="text-sm text-stone-400">Canada Marketplace Inc.</p>
                  <p className="text-sm text-stone-400">Email: <a href="mailto:privacy@canadamarketplace.ca" className="text-green-400 hover:underline">privacy@canadamarketplace.ca</a></p>
                  <p className="text-sm text-stone-400">Phone: <a href="tel:+16044971001" className="text-green-400 hover:underline">(604) 497-1001</a></p>
                  <p className="text-sm text-stone-400">Address: 14914 104 Ave, Unit 105, Surrey, BC V3R 1M7</p>
                </div>
