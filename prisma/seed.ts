...
async function seed() {
  ...
  const sellerData = [
    { name: "tunogkalye.net", email: "sarah@techshop.ca", store: "Canada Marketplace", province: "ON", city: "Toronto", desc: "Canada Marketplace — Your trusted Canadian online store. Premium quality T-shirts, mugs, caps, and hoodies inspired by street sound culture. All prices in CAD." },
    { name: "Marco Reyes", email: "jp@montrealfashion.ca", store: "Canada Marketplace West", province: "BC", city: "Vancouver", desc: "Canada Marketplace West Coast. Bringing premium streetwear and accessories to British Columbia. Your one-stop shop for Canadian style." },
    { name: "Émile Tremblay", email: "mike@homegear.ca", store: "Canada Marketplace Québec", province: "QC", city: "Montréal", desc: "Canada Marketplace Québec — Votre marché en ligne de confiance. Produits premium pour la communauté québécoise. Tous les prix en CAD." },
    { name: "Aisha Khan", email: "emily@sportsplus.ca", store: "Canada Marketplace Prairies", province: "AB", city: "Calgary", desc: "Canada Marketplace Prairies — Premium merchandise across Alberta and the Prairies. Quality products, Canadian prices." },
    { name: "Jordan Williams", email: "david@canread.ca", store: "Canada Marketplace Atlantic", province: "NS", city: "Halifax", desc: "Canada Marketplace Atlantic — East Coast quality, nationwide reach. Shipping across the Maritimes and beyond." },
  ]
  ...
  const notificationTemplates = [
    ...
    { user: buyers[0], type: "MESSAGE", title: "New Message", message: "Canada Marketplace sent you a message about Classic Logo Tee.", link: "messages" },
